...
public class Constant {
    ...
    //验证码图片id最大值
    public static final int CODE_MAX = 100000;

    //字符串判断枚举
    public static final int CHAR_FIRST_INT = 0;
    public static final int CHAR_FIRST_STR = 1;
    public static final int CHAR_FIRST_SP = 2;
